...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Ks(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gr(),fragmentShader:`
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Zs(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gr(),fragmentShader:`
...
`].filter(ti).join(`
`)),o=Fr(o),o=sa(o,t),o=aa(o,t),a=Fr(a),a=sa(a,t),a=aa(a,t),o=oa(o),a=oa(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
